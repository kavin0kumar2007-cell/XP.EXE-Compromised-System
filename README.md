...
## The desktop begins to glitch and show security alerts.
## The user must open the Virus Scanner.
## The scanner detects virus.exe.
## To remove it, the user must solve a small puzzle.
...
## JavaScript – system logic, apps, virus events
##  Features
## Windows XP style boot screen and login screen
## A desktop with draggable icons
## Start menu and taskbar
## Window system for apps
## File explorer simulation
## Simple terminal with commands
## Fake virus infection system
## Virus scanner
## Puzzle challenge to remove the virus
## BSOD restart simulation
## System returns to normal after cleanup
